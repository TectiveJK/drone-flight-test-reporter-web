...
const flightFields = ['flightDateTime','batteryId','duration','flightModes','missionPerformed','telemetrySummary','anomalies','expectedBehaviour','findings','operatorNotes','flightResult'];
